    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <!-- <router-link :to="'/'" class="btn btn-primary btn-margin">
            Home
          </router-link> -->
<!--
          <router-link :to="'profile'" class="btn btn-primary btn-margin" v-if="authenticated">
            Profile
          </router-link>

          <router-link :to="'admin'" class="btn btn-primary btn-margin" v-if="authenticated && admin">
            Admin Area
          </router-link> -->
          ...
          <!-- <button class="btn btn-primary btn-margin" @click="logout()">
                Log Out
            </button> -->
